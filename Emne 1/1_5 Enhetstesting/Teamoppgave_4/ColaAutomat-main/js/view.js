let fhiLink = '<a href="https://www.fhi.no/he/folkehelserapporten/ikke-smittsomme/diabetes" target="_blank">Mer informasjon</a>'
function updateView() {
    document.getElementById('app').innerHTML = /*HTML*/`
        <div class="flexVertical">
            ...
            <div>
                <br>
                 Du har tatt ${numberOfCokesPurchased} flasker cola${numberOfCokesPurchased>1 ? ` og er i faresonen for diabetes. ${fhiLink}`:""}. Du fått ${pocketChange}kr tilbake.
            </div>
            <div class="flexVertical">
                ...
                <div class="flexHorizontal">
                    ...
                    <button ${coinsInserted.reduce(function(a,b){return a+b;}) != 0 ? "":"disabled"} onclick="cancelPurchase()">Angre</button>
